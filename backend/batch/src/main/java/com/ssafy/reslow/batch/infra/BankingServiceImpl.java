...
public class BankingServiceImpl implements BankingService {
	...
	public Map<String, Object> receivedTransferAccountNumber(String bncd, String acno, String tram, String dractOtlt) {
		...
		String apiNm;
		if(bncd.equals("011") || bncd.equals("012") ) apiNm = "ReceivedTransferAccountNumber";
		else apiNm = "ReceivedTransferOtherBank";
		header.put("ApiNm", apiNm);
	...
	public Map<String, Object> inquireDepositorAccountNumber(String bncd, String acno) {
		...
		setTime();
		String apiNm;
		if(bncd.equals("011") || bncd.equals("012") ) apiNm = "InquireDepositorAccountNumber";
		else apiNm = "InquireDepositorOtherBank";
		header.put("ApiNm", apiNm);
