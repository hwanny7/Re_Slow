...
class _RecommendState extends State<Recommend>
  ...
  void _goKnowhow(knowhowNo) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => KnowHowDetail(knowhowNo: knowhowNo)));
  }
                            ...
                            Transform.translate(
                              ...
                              child: Expanded(
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      _goKnowhow(recommendations[0].knowhowNo);
                                    },
                                    child: Column(
                                      crossAxisAlignment:
                            ...
                            Transform.translate(
                              ...
                              child: Expanded(
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      _goKnowhow(recommendations[1].knowhowNo);
                                    },
                                    child: Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.stretch,
                            ...
                            Transform.translate(
                              ...
                              child: Expanded(
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      _goKnowhow(recommendations[2].knowhowNo);
                                    },
                                    child: Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.stretch,
